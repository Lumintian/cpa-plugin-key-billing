<div align="center">
  ...
  <p>
    <a href="https://github.com/Lumintian/cpa-plugin-key-billing/releases/latest"><img src="https://img.shields.io/github/v/release/Lumintian/cpa-plugin-key-billing?label=release" alt="Latest release"></a>
    <a href="https://github.com/Lumintian/cpa-plugin-key-billing/actions/workflows/check.yml"><img src="https://github.com/Lumintian/cpa-plugin-key-billing/actions/workflows/check.yml/badge.svg" alt="CI status"></a>
...
```sh
curl -LsSf https://raw.githubusercontent.com/Lumintian/cpa-plugin-key-billing/main/install.sh | sh
```

Windows 请先停止 CLIProxyAPI，再在 PowerShell 中运行：

```powershell
irm https://raw.githubusercontent.com/Lumintian/cpa-plugin-key-billing/main/install.ps1 | iex
```
